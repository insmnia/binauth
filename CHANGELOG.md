...
- add ability to specify db model to use in fastapi dependency to avoid table not found error during permissions resolution

## v0.3.0 (2025-12-27)

### Feat

- add generic table model for permission repository
